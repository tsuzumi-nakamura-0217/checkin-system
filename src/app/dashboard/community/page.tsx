        ...
        <div className="flex items-center gap-2">
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[425px] rounded-3xl border-none shadow-2xl">
              <DialogHeader>
                <DialogTitle className="text-xl font-black tracking-tight">新しい目標を設定</DialogTitle>
              </DialogHeader>
              <form onSubmit={handleCreateGoal} className="space-y-5 pt-4">
                <div className="space-y-2">
                  <Label htmlFor="title" className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest ml-1">目標名</Label>
                  <Input 
                    id="title" 
                ...
                <div className="space-y-2">
                  <Label className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest ml-1">目標タイプ</Label>
        ...
        <>
          {goal ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center border-2 border-dashed border-border rounded-3xl bg-secondary/10 opacity-60">
              ...
              <h3 className="text-xl font-bold tracking-tight">アクティブな目標がありません</h3>
              <p className="mt-2 text-sm text-muted-foreground max-w-[300px]">
                「目標を設定する」ボタンから最初のプロジェクトを始めましょう。
              </p>
            </div>
          )}
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {isHistoryLoading ? (
                ...
                <div className="col-span-full py-20 text-center border-2 border-dashed border-border rounded-3xl bg-secondary/10 opacity-60">
                   <p className="text-sm font-medium text-muted-foreground">過去の目標履歴はありません。</p>
                </div>
              ) : (
                history.map((h) => (
                  <div 
                  ...
                  >
                    ...
                    <p className="text-xs font-bold text-muted-foreground mb-4">
                      {h.targetPoints.toLocaleString()} pts 目標
                    </p>
